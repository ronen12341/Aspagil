...
Do not repeat the previous mistakes.`;
    ...
    // ============================================================
    // STEP 2 — REPLACED by client-side deterministic mockup.
    // The browser now wraps the flat onto a paper-cup template using CSS,
    // guaranteeing the customer preview = the print file (same image).
    // This also saves ~50% of OpenAI image-gen cost and ~20s of wait time.
    // ============================================================
    const mockupImg = {
      b64_json: flatB64 || null,
      url: flatUrl || null
    };
    const mockupResult = { ok: true, model: 'css-mockup-from-flat', error: null };
